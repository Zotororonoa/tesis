function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy, test_gmean] = ELM(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
