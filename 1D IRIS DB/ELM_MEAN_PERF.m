function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy, test_gmean] = ELM_MEAN_PERF(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
